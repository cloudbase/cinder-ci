...
echo "Getting Hyper-V logs from $hyperv01 and $ws2012r2"
get_win_files $hyperv01 "\OpenStack\logs" "$LOG_DST_WIN/$hyperv01-compute01"
get_win_files $ws2012r2 "\OpenStack\logs" "$LOG_DST_WIN/$ws2012r2-cinder"

echo "Getting Hyper-V configs from $hyperv01 and $ws2012r2" 
get_win_files $hyperv01 "\OpenStack\etc" "$CONFIG_DST_WIN/$hyperv01-compute01"
get_win_files $ws2012r2 "\OpenStack\etc" "$CONFIG_DST_WIN/$ws2012r2-cinder"
