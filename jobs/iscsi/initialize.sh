...
scp -v -r -o "StrictHostKeyChecking no" -o "UserKnownHostsFile /dev/null" -i $DEVSTACK_SSH_KEY /usr/local/src/cinder-ci/devstack_vm/* ubuntu@$FLOATING_IP:/home/ubuntu/ >> /var/lib/jenkins/jenkins-master/logs/console-$NAME.log 2>&1
...
scp -v -r -o "StrictHostKeyChecking no" -o "UserKnownHostsFile /dev/null" -i $DEVSTACK_SSH_KEY /usr/local/src/cinder-ci/devstack_vm/devstack/* ubuntu@$FLOATING_IP:/home/ubuntu/devstack >> /var/lib/jenkins/jenkins-master/logs/console-$NAME.log 2>&1
