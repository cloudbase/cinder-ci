...
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_FLOATING_IP /home/jenkins-slave/admin-msft.pem "mkdir -p /home/ubuntu/devstack/files/images/"
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_FLOATING_IP /home/jenkins-slave/admin-msft.pem "wget http://dl.openstack.tld/cirros-0.3.3-x86_64.vhdx -O /home/ubuntu/devstack/files/images/cirros-0.3.3-x86_64.vhdx"
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_FLOATING_IP /home/jenkins-slave/admin-msft.pem "wget http://dl.openstack.tld/Fedora-x86_64-20-20140618-sda.vhdx -O /home/ubuntu/devstack/files/images/Fedora-x86_64-20-20140618-sda.vhdx"
