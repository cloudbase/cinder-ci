...
function join_hyperv (){
    run_wsmancmd_with_retry 3 $1 $2 $3 'powershell -ExecutionPolicy RemoteSigned Remove-Item -Recurse -Force C:\OpenStack\cinder-ci ; git clone https://github.com/cloudbase/cinder-ci C:\OpenStack\cinder-ci ; cd C:\OpenStack\cinder-ci ; git checkout cambridge-test >>\\'$FIXED_IP'\openstack\logs\hyperv0'$4'\create-environment-'$1'.log 2>&1'
    run_wsmancmd_with_retry 3 $1 $2 $3 'powershell -ExecutionPolicy RemoteSigned C:\OpenStack\cinder-ci\HyperV\scripts\teardown.ps1'
    run_wsmancmd_with_retry 3 $1 $2 $3 'powershell -ExecutionPolicy RemoteSigned C:\OpenStack\cinder-ci\HyperV\scripts\EnsureOpenStackServices.ps1 Administrator H@rd24G3t >>\\'$FIXED_IP'\openstack\logs\hyperv0'$4'\create-environment-'$1'.log 2>&1'
    [ "$IS_DEBUG_JOB" == "yes" ] && run_wsmancmd_with_retry 3 $1 $2 $3 '"powershell Write-Host Calling create-environment with devstackIP='$FIXED_IP' branchName=master buildFor=openstack/neutron '$IS_DEBUG_JOB' >>\\'$FIXED_IP'\openstack\logs\hyperv0'$4'\create-environment-'$1'.log 2>&1"'
    run_wsmancmd_with_retry 3 $1 $2 $3 '"powershell -ExecutionPolicy RemoteSigned C:\OpenStack\cinder-ci\HyperV\scripts\create-environment.ps1 -devstackIP '$FIXED_IP' -branchName master -buildFor openstack/neutron '$IS_DEBUG_JOB' >>\\'$FIXED_IP'\openstack\logs\hyperv0'$4'\create-environment-'$1'.log 2>&1"'
}
...
join_windows(){
    ...
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\EnsureOpenStackServices.ps1 '$WIN_USER' '$WIN_PASS' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    echo "create cinder env on windows"
    #run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\create-environment.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\ensure_ci_repo.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\ensure_python.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\ensure_pip_pkgs.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\initial_cleanup.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\install_cinder.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\create_config.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
    run_ps_cmd_with_retry 3 $PARAMS '"C:\cinder-ci\windows\scripts\start_services.ps1 -devstackIP '$FIXED_IP' -branchName '$ZUUL_BRANCH' -buildFor '$ZUUL_PROJECT' -testCase '$JOB_TYPE' -winUser '$WIN_USER' -winPasswd '$WIN_PASS' -hypervNodes '$HYPERV_NODES' >>\\'$FIXED_IP'\openstack\logs\windows\create-environment-'$WIN_IP'.log 2>&1"'
}
